...
type Client interface {
	...
	GetInfo(ctx context.Context, req *user.InfoRequest, callOptions ...callopt.Option) (r *user.InfoResponse, err error)
	AvatarUpload(ctx context.Context, req *user.AvatarUploadRequest, callOptions ...callopt.Option) (r *user.AvatarUploadResponse, err error)
...
func (p *kUserServiceClient) GetInfo(ctx context.Context, req *user.InfoRequest, callOptions ...callopt.Option) (r *user.InfoResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetInfo(ctx, req)
}

func (p *kUserServiceClient) AvatarUpload(ctx context.Context, req *user.AvatarUploadRequest, callOptions ...callopt.Option) (r *user.AvatarUploadResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.AvatarUpload(ctx, req)
}
